...
///
/// Create an instance of this widget with [ZefyrButton.icon], [ZefyrButton.widget] or
...
class _ModeColorButtonState extends State<ModeColorButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return toolbar.buildButton(
      context,
      (widget.modeChosen == 1)
          ? ZefyrToolbarAction.lightMode
          : ZefyrToolbarAction.darkMode,
      onPressed: showOverlay,
    );
  }
  ...
  Widget buildOverlay(BuildContext context) {
    ...
    return ZefyrToolbarScaffold(
      ...
      buttons: (widget.modeChosen == 1) ? lightModeColors : darkModeColors,
    ));
  }
}
